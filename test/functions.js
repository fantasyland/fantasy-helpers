...
exports.functionName = {
    ...
    'when calling functionName with a unnamed function should return correct name': function(test) {
...
exports.functionLength = {
    'when calling functionLength with no parameters should return correct length': function(test) {
        test.equals(λ.functionLength(function (){}), 0);
        test.done();
    },
    'when calling functionLength with one parameter should return correct length': function(test) {
        test.equals(λ.functionLength(function (a){}), 1);
        test.done();
    },
    'when calling functionLength with multiple parameters should return correct length': function(test) {
